...
from Ankit import LOGGER, dispatcher
from Ankit.modules.helper_funcs.chat_status import dev_plus
...
def do(func, bot, update):
    ...
    os.chdir(os.getcwd())
    with open(
        os.path.join(os.getcwd(), "Ankit/modules/helper_funcs/temp.txt"), "w"
    ) as temp:
        temp.write(body)
